...
<html lang="fr">
	...
	<head>
		...
		<!-- favicon -->
		<link rel="icon" href="http://www.videogamesprites.net/SeikenDensetsu3/Magic/Rainbow.gif">
		<meta charset="utf-8">
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-lg-2">
					<form action="#" method="post" id="formPanel">
						...
						<fieldset class="form-group">
							...
							<input type="submit" id="sortSubmit" name="sortSubmit" class="form-control btn btn-danger mt-1" value="Send !" data-toggle="tooltip" data-placement="top" title="on laisse le choix à l'utilisateur de la classe désirée. Si un héros est sélectionné, on randomise la classe de ce héros-là !">
						</fieldset>
					</form>
				</div>
				...
				<div class="col-lg-8">
					<h3 class="h3 text-center list-group-item-light pb-2 text-secondary">Your team result <a class="badge badge-danger badge-link badge-pill" data-toggle="tooltip" data-placement="top" title="petit bouton pour descendre en bas de la page, là où il y a les infos concernant l'équipe en elle-même" href="#focusBlock">Skip to details</a></h3>
